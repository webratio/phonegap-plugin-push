...
public final class GCMConstants {
    ...
    /**
     * Extra used on {@value #INTENT_TO_GCM_REGISTRATION} to indicate which senders (Google API project ids) can send messages to the
     * application.
     */
    ...
    /**
     * Extra used on {@value #INTENT_FROM_GCM_REGISTRATION_CALLBACK} to indicate an error when the registration fails. See constants
     * starting with ERROR_ for possible values.
     */
    ...
    /**
     * Type of message present in the {@value #INTENT_FROM_GCM_MESSAGE} intent. This extra is only set for special messages sent from
     * GCM, not for messages originated from the application.
     */
    ...
    /**
     * The device can't read the response, or there was a 500/503 from the server that can be retried later. The application should use
     * exponential back off and retry.
     */
    public static final String ERROR_SERVICE_NOT_AVAILABLE = "SERVICE_NOT_AVAILABLE";

    /**
     * There is no Google account on the phone. The application should ask the user to open the account manager and add a Google
     * account.
     */
    public static final String ERROR_ACCOUNT_MISSING = "ACCOUNT_MISSING";

    /**
     * Bad password. The application should ask the user to enter his/her password, and let user retry manually later. Fix on the
     * device side.
     */
