...
var PushNotification = function(options) {
    ...
    var success = function(result) {
        if (result && typeof result.registrationId !== 'undefined') {
            ...
            that.emit(result.additionalData.actionCallback, result);
        } else if (result) {
 ...
 * @return  {void}
 */
PushNotification.prototype.subscribe = function(
    topic,
    successCallback,
    errorCallback
) {
 ...
 * @return  {void}
 */
PushNotification.prototype.unsubscribe = function(
    topic,
    successCallback,
    errorCallback
) {
...
PushNotification.prototype.emit = function() {
    ...
    for (
        var i = 0, length = this._handlers[eventName].length;
        i < length;
        i++
    ) {
